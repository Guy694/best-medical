...
"use client";
import { article, image } from 'framer-motion/client';
  ...
  const article = [
    {
      ...
      content: "ยินดีต้อนรับสู่ส่วนบทความและข่าวสารของเรา ที่นี่คุณจะพบกับข้อมูลที่เป็นประโยชน์และข่าวสารล่าสุดเกี่ยวกับสุขภาพและการดูแลตัวเอง",
      details: [
        "บทความ 1: วิธีการดูแลสุขภาพในช่วงฤดูฝน",
        "บทความ 2: 5 เคล็ดลับในการเลือกซื้ออุปกรณ์การแพทย์",
        "ข่าวสาร: โปรโมชั่นพิเศษสำหรับลูกค้าใหม่"
      ],
      contact: [
        "โทรศัพท์: 012-345-6789",
        "อีเมล: support@best-medical.com"
      ],
      image: "/article.png",
